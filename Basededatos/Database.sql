...
insert into usuarios(id,email,contrasenia,fechadenacimiento,dni,fotodeperfil)values(default,"santino@gmail.com","hola123",'2002-05-12',44367108,"imagen.jpg");
insert into usuarios (id,email,contrasenia,fechadenacimiento,dni,fotodeperfil)values(default,"tomas@gmail.com","chau321",'2004-04-13',4677098,"foto.jpg");
insert into usuarios (id,email,contrasenia,fechadenacimiento,dni,fotodeperfil)values(default,"pepe@hotmail.com","bocaelmasgrande",'2003-07-20',91202321,"foto.jpg");
...
insert into productos (id,usuario_id,producto,descripcionProd)values(default,2,"Apple AirPods Max","Los AirPods Max reinventan los audífonos de diadema. El controlador dinámico diseñado por Apple te ofrece un sonido inmersivo de alta fidelidad");
